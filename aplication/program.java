        ...
        switch (navegacao) {
          ...
          case 1:
            ...
            case 4:
              ...
              ficha clienteFicha = repositorioFichas.consultarCPF(cpfClienteComida);     
                ...
                do {
                    ...
                    switch (comidaEscolhida) {
                      case 1:
                        ...
                        System.out.println("Coca Cola comprada por R$ " + preco);
                        clienteFicha.setValorPagar(clienteFicha.getValorPagar() + preco);
                        break;
                      
                      case 2:
                        preco = frigobar.getPrecoEnergetico();
                        System.out.println("Energetico comprado por R$ " + preco);
                        clienteFicha.setValorPagar(clienteFicha.getValorPagar() + preco);
                        break;
                      
                      case 3:
                        preco = frigobar.getPrecoChocolate();
                        System.out.println("chocolate comprado por R$ " + preco);
                        clienteFicha.setValorPagar(clienteFicha.getValorPagar() + preco);
                        break;

                      case 4:
                        preco = frigobar.getPrecoSalgadinho();
                        System.out.println("Salgadinho comprado por R$ " + preco);
                        clienteFicha.setValorPagar(clienteFicha.getValorPagar() + preco);
                        break;
